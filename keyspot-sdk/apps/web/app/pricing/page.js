      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border-2 border-zinc-950 dark:border-white p-8 relative">
            ...
            <link_1.default href="/pricing#dashboard" className="mt-8 block w-full rounded-full bg-zinc-950 dark:bg-white py-3 text-center text-sm font-medium text-white dark:text-zinc-950 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition">
              Get API keys
            </link_1.default>
          </div>
        </div>
        ...
        <div id="dashboard" className="mt-16 text-center">
          <link_1.default href="/dashboard" className="inline-flex items-center gap-2 text-sm font-medium underline underline-offset-4">
