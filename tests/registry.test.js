...
describe('PatternRegistry', () => {
    ...
    it('register adds a new pattern', () => {
        const registry = new PatternRegistry([]);
        const pattern = { name: 'test_key', regex: /test-\w+/g, severity: 'high', description: 'Test' };
    ...
    it('buildTrie rebuilds after register', () => {
        const registry = new PatternRegistry([]);
        const pattern = { name: 'custom_key', regex: /custom_\w+/g, severity: 'high', description: 'Custom' };
        registry.register(pattern);
